...
def test_multiple_attributes():
    ...
    table = MyTable.from_kwargs(name="foo", id=1, vals=[1, 2, 3], fval=2.5)
...
class TestStringAttribute:
    ...
    def test_mutation(self, tmp_path):
        table = self.MyTable.from_kwargs(name="foo", mutable_name="bar", vals=[1, 2, 3])
...
class TestIntAttribute:
    ...
    def test_from_kwargs(self):
        table = self.MyTable.from_kwargs(id=1, vals=[1, 2, 3])
...
class TestFloatAttribute:
    ...
    def test_from_kwargs(self):
        table = self.MyTable.from_kwargs(id=1.5, vals=[1, 2, 3])
